      ...
      <main>
        <div className={`${style.hero} ${style.sectionP1}`}>
          <div>
            ...
            <br />
            <span>
              Discover the perfect jewelry pieces &nbsp;&nbsp; for your uniqye
              style at our store
            </span>
            <br />
            <br />
        ...
        <section
          className={`${style.sectionP1} ${style.sectionM1}`}
          id={`${style.collection}`}
        >
         ...
         <Link to="/products"  element={<Products/>} > <div className={`${style.productContainer}`}>
            <div className={`${style.card}`}>
              <img
                className={`${style.cardImg}`}
                src={require(`../Components/image/card1.png`)}
                alt="Card 1"
              />
            ...
            <div className={`${style.card}`}>
              <img
                className={`${style.cardImg}`}
                src={require(`../Components/image/card2.jpg`)}
                alt="Card 2"
              />
            ...
            <div className={`${style.card}`}>
              <img
                className={`${style.cardImg}`}
                src={require(`../Components/image/card3.png`)}
                alt="Card 3"
              />
            ...
            <div className={`${style.card}`}>
              <img
                className={`${style.cardImg}`}
                src={require(`../Components/image/card4.jpg`)}
                alt="Card 4"
              />
              <p className={`${style.cardTitle}`}>Messika</p>
        ...
        >
          ...
          <Link to="/necklaces" element={<Necklaces/>} >
          <div className={`${style.productContainer}`}>
            <div className={`${style.card}`}>
              <img
                className={`${style.cardImg}`}
                src={require(`../Components/image/card5.png`)}
                alt="Card 1"
              />
              <p className={`${style.cardTitle}`}>Messika</p>
            ...
            <div className={`${style.card}`}>
              <img
                ...
                className={`${style.cardImg}`}
                src={require(`../Components/image/card6.png`)}
                alt="Card 2"
              />
            ...
            <div className={`${style.card}`}>
              <img
                className={`${style.cardImg}`}
                src={require(`../Components/image/card7.png`)}
                alt="Card 3"
              />
        ...
        >
          <div>
            <img
              src={require(`../Components/image/giftBox.png`)}
              alt="Gift Box"
            />
          </div>
        ...
        <section className={`${style.sectionP1} `} id={`${style.about}`}>
          <div className={`${style.firstDiv}`}>
            <div>
              ...
              <p>
                ...
                by the most experienced master jewelers
              </p>
              <p>
                We are constantly expanding our range to meet the needs of our
                customers and offer them latest and most fashionable trnds in
                jewelry. We are confident that our collection of jewelry will
          ...
          <div className={`${style.secondDiv} ${style.sectionM1}`}>
            <div>
              <img
                src={require("../Components/image/meeting.png")}
                alt="Meeting img"
              />
            </div>
